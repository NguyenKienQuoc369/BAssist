...
import { Heart, Send, Paperclip, X, Database } from "lucide-react";
...
export default function PersonalDoctor() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "assistant",
      content: "Chào bạn! 🏥 Mình là Personal Doctor, trợ lý sức khỏe và wellness của bạn. Mình có thể giúp bạn hiểu rõ hơn về các vấn đề sức khỏe, gợi ý cách cải thiện lifestyle, hỗ trợ về dinh dưỡng và tập thể dục, cân bằng giữa công việc và sức khỏe tinh thần.\n\n⚠️ Tuy nhiên, mình chỉ là trợ lý wellness - không phải bác sĩ thực tế. Nếu bạn có các vấn đề y tế nghiêm trọng, hãy liên hệ với bác sĩ chuyên khoa nhé!\n\nBạn hôm nay có gì phát sinh không?"
    }
  ]);
  ...
  const handleSend = async () => {
    if (!input.trim() && files.length === 0) {
      setError("Vui lòng nhập thông tin sức khỏe hoặc tải lên tệp");
      return;
    }
    ...
    try {
      ...
      addHistory("personal-doctor", newMessages);
    } catch (err: any) {
  ...
  return (
    <div className="flex min-h-screen">
      ...
      <main className={`flex-1 flex flex-col transition-colors duration-300 ${
        ...
        <div className={`p-4 backdrop-blur transition-colors duration-300 ${
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              }`}>Tư vấn sức khỏe và chăm sóc cá nhân hóa</p>
            </div>
        ...
        <div className={`flex-1 overflow-y-auto p-4 transition-all duration-500 relative ${
          isDark
          ...
          <div className="max-w-3xl mx-auto space-y-3 relative z-10">
            {messages.length === 0 && (
              <div className="text-center text-gray-400 py-20 animate-fade-up">
                ...
                <p className="text-sm font-medium">Hỏi về sức khỏe của bạn</p>
              </div>
            )}
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="flex gap-2">
              ...
              <textarea
                ...
                placeholder="Mô tả triệu chứng hoặc câu hỏi sức khỏe... (Enter gửi)"
